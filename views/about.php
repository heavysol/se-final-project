...
function getDashboardUrl() {
    ...
    if (!isLoggedIn()) {
        return "$base/views/login.php";
    }
    
    switch ($_SESSION['role']) {
        case 'admin':
            return "$base/views/dashboards/admin/admin_dashboard.php";
        case 'organizer':
            return "$base/views/dashboards/organiser/organizer_dashboard.php";
        case 'student':
            return "$base/views/dashboards/student/student_dashboard.php";
        default:
            return "$base/views/login.php";
    }
}
...
<head>
    ...
    <style>
        ...
        .about-hero {
            background-color: rgba(165, 56, 56, 1); 
            color: white;
            text-align: center;
            padding: 8rem 0;
            margin-bottom: 4rem;
